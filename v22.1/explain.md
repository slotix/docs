...
`DDL`              | Print a plan of what the schema changer will do when invoked on statements supported by the declarative schema changer. See [`DDL` option](#ddl-option).
...
To view the plan of what the schema changer will do for statements supported by the declarative schema changer
